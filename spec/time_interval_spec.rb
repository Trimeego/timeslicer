...
describe Timeslicer::TimeInterval do
  before(:each) do
  ...
  it "should not accept empty initializers" do
    begin
      Timeslicer::TimeInterval.new().nil?
    rescue
      true
    end
  end
  ...
  it "should bracket correctly on hour" do
    ...
    ti = Timeslicer::TimeInterval.new(@test_time, 'hour')
    ti.start_time.should == target_start
    ti.end_time.should == target_end
  end
  it "should bracket correctly on day" do
    ...
    ti = Timeslicer::TimeInterval.new(@test_time, 'day')
    ti.start_time.should == target_start
    ti.end_time.should == target_end
  end
  it "should bracket correctly on week" do
    ...
    target_end = Time.mktime(2011, 2, 6)-1
    ti = Timeslicer::TimeInterval.new(@test_time, 'week')
    ti.start_time.should == target_start
    ti.end_time.should == target_end
  end
  it "should bracket correctly on month" do
    ...
    ti = Timeslicer::TimeInterval.new(@test_time, 'month')
    ti.start_time.should == target_start
    ti.end_time.should == target_end
  end
  it "should bracket correctly on year" do
    ...
    ti = Timeslicer::TimeInterval.new(@test_time, 'year')
    ti.start_time.should == target_start
    ti.end_time.should == target_end
  end
